...
export function AuthHelpModal({ isOpen, onClose, domain }: AuthHelpModalProps) {
  const copyDomain = () => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-zinc-950 border-zinc-800 text-zinc-100 sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogTitle className="text-2xl font-bold tracking-tight">Access Restricted</DialogTitle>
